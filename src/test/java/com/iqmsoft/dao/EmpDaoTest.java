...
import com.iqmsoft.util.DateTimeConverters;
...
public class EmpDaoTest {
    ...
    public void testFindWithDname() throws SQLException {
        ...
        assertThat(result.size(), is(5));
        assertThat(result.get(0).toString(), 
                is("EmpDept(empno=1, ename=Scott, hiredate=2017-01-02, deptno=100, dname=PROGRAMMER)"));
    }
    ...
    public void testFindWithDnameByMap() throws SQLException {
        ...
        assertThat(result.size(), is(5));
        assertThat(result.get(0).toString(), 
                is("{ENAME=Scott, HIREDATE=2017-01-02, ID=1, DEPTNO=100, DNAME=PROGRAMMER}"));
    }
